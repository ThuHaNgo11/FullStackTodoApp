...
app.post("/todos/:userId", async (req, res) => {
    try {
        ...
        // add todo to the existing todos collection
        await newTodo.save();

        // add todo to the todos array in the user table (user collection)
...
app.patch("/todos/:todoId/completed", async (req, res) => {
    try {
...
// fetch todos in a particular date
